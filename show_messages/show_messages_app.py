...
* KAFKA_BOOTSTRAP_SERVERS - the URL for the Kafka bootstrap server, including username and password
* SCHEMA_REGISTRY_URL - the URL for the Karapace schema service, including username and password
...
KAFKA_BOOTSTRAP_SERVERS = os.getenv("KAFKA_BOOTSTRAP_SERVERS")      # including username and password
...
async def update_input_panel(request: Request) -> HTMLResponse:
...
@app.get("/update/output")
async def update_output_panel(request: Request) -> HTMLResponse:
