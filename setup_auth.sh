...
# Set up the trust and key stores for our Java application
#
# Remember to `source` this, as the caller needs the environment
# variable PASSWORD_FOR_STORE that we create.
